...
const landingSectionContent = {
  ...
  BG: {
    heading: 'উইন্ডোজ ১১',
    description:
      "উইন্ডোজ 11 একটি দুর্দান্ত এবং সৃজনশীল জায়গা সরবরাহ করে যেখানে আপনি একটি নতুন অভিজ্ঞতার মাধ্যমে আপনার আবেগকে অনুসরণ করতে পারেন। পুনরায় ডিজাইন করা স্টার্ট মেনু থেকে শুরু করে আপনার প্রিয় ব্যক্তি, সংবাদ, গেমস এবং সামগ্রীর সাথে সংযোগ স্থাপনের নতুন উপায়গুলিতে, উইন্ডোজ হ'ল প্রাকৃতিক উপায়ে চিন্তাভাবনা, প্রকাশ এবং তৈরি করার জায়গা।",
  },
}
...
const LandingSection = () => {
  const getLandingSectionData = activeLanguage => {
    switch (activeLanguage) {
      ...
      case 'BG':
        return landingSectionContent.BG
      default:
        return null
    }
  }
