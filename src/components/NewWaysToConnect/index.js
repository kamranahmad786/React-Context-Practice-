...
const newWaysToConnectContent = {
  ...
  BG: {
    heading: 'সংযোগ করার নতুন উপায়',
    description:
      'মাইক্রোসফ্ট টিমসের সাথে সরাসরি আপনার ডেস্কটপ থেকে আপনার যত্নের লোকদের সাথে তাত্ক্ষণিকভাবে সংযোগ করুন। বিনামূল্যে কল করুন বা চ্যাট করুন - তারা যে ডিভাইসেই থাকুক না কেন।',
  },
}
...
const NewWaysToConnect = () => {
  const getNewWaysToConnectData = activeLanguage => {
    switch (activeLanguage) {
      ...
      case 'BG':
        return newWaysToConnectContent.BG
      default:
        return null
    }
  }
