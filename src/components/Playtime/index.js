...
const playtimeContent = {
  ...
  BG: {
    heading: 'খেলার সময়। যে কোন সময়',
    description:
      'উইন্ডোজ গ্রাফিক ক্ষমতা সহ গেমিংকে সম্পূর্ণ নতুন স্তরে নিয়ে যায় যা বাস্তবতার প্রতিদ্বন্দ্বী। এক্সবক্স গেম পাসের সাহায্যে আপনার পরবর্তী প্রিয় গেমটি সন্ধান করুন, আপনাকে 100 টিরও বেশি উচ্চ-মানের গেমগুলিতে অ্যাক্সেস দেয়।',
  },
}
